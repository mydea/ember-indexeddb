...
module('Unit | Utility | clone-deep', function () {
  test('it works', function (assert) {
    ...
    assert.deepEqual(
      result,
      obj,
      'it has the same content as the source object'
    );
    ...
    assert.notEqual(
      result.nestedArray,
      obj.nestedArray,
      'nested array is cloned'
    );
    assert.notEqual(
      result.nestedArray[0],
      obj.nestedArray[0],
      'nested array content is cloned'
    );
    assert.notEqual(
      result.nestedArray[0].val3,
      obj.nestedArray[0].val3,
      'nested array content object is cloned'
    );
